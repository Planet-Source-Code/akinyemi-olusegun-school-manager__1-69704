...
Begin VB.Form frmdiscountae 
   ...
   End
End
Attribute VB_Name = "frmdiscountae"
...
Dim rs As Recordset
Call link
Set rs = db.OpenRecordset("select * from discount where discount='" & txtfee.Text & "'")
With rs
    If .RecordCount > 0 Then
        .Edit
        rs("discount") = txtfee.Text
