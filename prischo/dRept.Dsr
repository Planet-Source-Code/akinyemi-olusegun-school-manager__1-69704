VERSION 5.00
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} dRept 
   ClientHeight    =   7365
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6870
   ...
   _ExtentY        =   12991
   FolderFlags     =   1
   TypeLibGuid     =   "{ABA85E30-9C10-42A5-AC59-596269CE5AE0}"
   TypeInfoGuid    =   "{AAFDBC0C-D919-4BAC-BE8C-9924161F5730}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\prischo\DATA.MDB;Persist Security Info=False"
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
   NumRecordsets   =   1
